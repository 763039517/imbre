    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 123 && resultCode == RESULT_OK) {
            try {
                ...
                Pipe imebraPipe = new Pipe(32000);
                ...
                DataSet loadDataSet = CodecFactory.load(new StreamReader(imebraPipe));
                ...
                mTextView.setText(loadDataSet.getString(new TagId(0x10,0x10), 0, "Undefined"));
            }
            catch(IOException e) {
            }
        }
